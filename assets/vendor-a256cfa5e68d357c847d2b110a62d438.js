...
return function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function")
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&p(e,t)}(t,e),n=t,(i=[{key:"addContextMenuListeners",value:function(){window.addEventListener("click",this.closeContextMenu),window.addEventListener("contextmenu",this.closeContextMenu),document.querySelector("#popper-for-".concat(this.popperId)).parentElement.addEventListener("contextmenu",this.contextMenu)}},{key:"willDestroy",value:function(){var e=document.querySelector("#popper-for-".concat(this.popperId))
...
var t="popper-for-".concat(this.popperId)
this.rightClickMenu.createPopper(t)}},{key:"closeContextMenu",value:function(e){var t=document.querySelector("#popper-for-".concat(this.popperId)).parentElement
...
return function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function")
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&u(e,t)}(n,Ember.Service),l=n,(f=[{key:"createPopper",value:function(e){var n=document.querySelector("#".concat(e)),r=n?n.parentElement:document.querySelector("#".concat(e.replace("popper-for-",""))),i=!0,o=!1,a=void 0
try{for(var s,u=r.parentElement.children[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value
this.closePopper(c)}}catch(f){o=!0,a=f}finally{try{i||null==u.return||u.return()}finally{if(o)throw a}}if(r&&n&&!this.activeLists.find((function(e){return e.targetElement===r&&e.popperElement===n}))){var l=t.default.createPopper(r,n,{placement:"right"})
n.setAttribute("data-show",""),this.activeLists.pushObject({targetElement:r,popperElement:n,popperInstance:l})}}},{key:"closePopper",value:function(e){var t=this.activeLists.findBy("targetElement",e)
